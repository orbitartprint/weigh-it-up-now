...
export const hydrationForHealth = {
  ...
  heroImageAlt: "A refreshing glass of water with ice and lemon slices next to a person exercising, symbolizing the importance of hydration for health and activity.",
  category: "Nutrition",
